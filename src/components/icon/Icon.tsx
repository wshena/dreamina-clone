...
import { FaArrowLeft, FaRegBookmark, FaBookmark, FaRegEye, FaRegEyeSlash } from "react-icons/fa";
...
export const RedoIcon = ({size, color, style}:Icon) => {
  return <BsArrowRepeat size={size} color={color} className={style} />
}

export const TrashIcon = ({size, color, style}:Icon) => {
  return <FiTrash size={size} color={color} className={style} />
}

export const PencilIcon = ({size, color, style}:Icon) => {
  return <PiPencilSimpleLineDuotone size={size} color={color} className={style} />
}

export const CloseEyeIcon = ({size, color, style}:Icon) => {
  return <FaRegEyeSlash size={size} color={color} className={style} />
}

export const OpenEyeIcon = ({size, color, style}:Icon) => {
